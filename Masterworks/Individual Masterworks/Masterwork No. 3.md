...
-   **Level 8:** Duplicate Self (Your armor can become an automaton in service to you. As an action you can command it to seperate from yourself and take on a physical form. It has the appearance of a sillouette constructed of flowing gallium, and uses the statistics of animated armor It uses the standard familliar rules, but cannot be damaged either.)
